...
btnSiguiente.addEventListener('click', (event) => {
    ...
    const fechaFinReserva = document.getElementById('fecha-fin-reserva').value;
    const cantidad = document.getElementById('cantidad-unidades').value;
    let precio = document.getElementById('reserva-precio').textContent;
...
function confirmarReserva() {
    ...
    const fechaFinReserva = document.getElementById('fecha-fin-reserva').value;
    const cantidad = document.getElementById('cantidad-unidades').value;
    const precio = document.getElementById('reserva-precio').textContent;
